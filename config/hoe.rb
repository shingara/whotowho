...
GEM_NAME = 'whotowho' # what ppl will type to install your gem
RUBYFORGE_PROJECT = 'whotowho' # The unix name for your project
...
Run 'rubyforge setup' to prepare your env for access to Rubyforge
 - See http://whotowho.rubyforge.org/rubyforge.html for more details
      EOS
      exit
    end
  end
...
VERS = WhoToWho::VERSION::STRING + (REV ? ".#{REV}" : "")
RDOC_OPTS = ['--quiet', '--title', 'testwhotowho documentation',
    "--opname", "index.html",
    "--line-numbers", 
    "--main", "README",
    "--inline-source"]
